...
class LookAccount
{
	...
	protected function handleBlockedAccount(Account &$lookingAccount, ?AccountRelationship $relasitonship1, ?AccountRelationship $relasitonship2, AccountEditingResult &$accountEditingResult)
	{
		if (
	...
	protected function handleFriendAccount(Account &$lookingAccount, ?AccountRelationship $relasitonship1, ?AccountRelationship $relasitonship2, AccountEditingResult &$accountEditingResult)
	{
		if (
	...
	protected function handleStrangerAccount(Account &$lookingAccount, ?AccountRelationship $relasitonship1, ?AccountRelationship $relasitonship2, AccountEditingResult &$accountEditingResult)
	{
		if (true) {
			//	stranger account
