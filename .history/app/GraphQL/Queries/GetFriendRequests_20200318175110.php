...
class GetFriendRequests
{
	...
	public function __invoke($rootValue, array $args, GraphQLContext $context, ResolveInfo $resolveInfo): array
	{
		...
		if ($rootValue['verified_account']) {
			...
			if ($currentAccount) {
				$friendRequests = AccountRelationship::where('relationship_type', AccountRelationshipType::FRIEND_REQUEST)->where('receiver_account_id', $currentAccount->id)->get(['sender_account_id', 'receiver_account_id', 'updated_at']);
