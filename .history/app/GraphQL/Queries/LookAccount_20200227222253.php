...
class LookAccount
{
	...
	protected function handleBlockedAccount(?AccountRelationship $relasitonship1, ?AccountRelationship $relasitonship2, AccountEditingResult $accountEditingResult){
		if (
