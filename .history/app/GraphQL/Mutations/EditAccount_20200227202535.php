...
class EditAccount
{
	...
	protected function updateEmail(Account &$account, ?string $email, AccountEditingResult &$accountEditingResult): bool
	{
		$booleanResult = true;
	...
	protected function updatePhone(Account &$account, ?string $email, AccountEditingResult &$accountEditingResult): bool
	{
		$booleanResult = true;
	...
	protected function updateInfo(Account &$account, string $dbAccountPropInfoName, string $dbAccountPropInfoColumnName, $clientInfo, string $infoName, AccountEditingResult &$accountEditingResult): bool{
		$account->$dbAccountPropInfoName->$dbAccountPropInfoColumnName = $clientInfo->month;
		$account->$dbAccountPropInfoName->privacy_type = $clientInfo->privacyType;
